/**
 * shop.icons.js — Stage 15.2
 * مكتبة أيقونات محلية بنفس مكتبة مرجع unblocksyria.com (Lucide) — نسخ محلي، بلا CDN.
 * viewBox 0 0 24 24 · stroke: currentColor · stroke-width 2 · fill: none (كما في المرجع).
 */
(function (global) {
  'use strict';
  ...
  // مسارات Lucide الرسمية (نفس هندسة المرجع)
  var PATHS = {
  ...
  /** يعيد عنصر SVG (Lucide) جاهزاً للإدراج. */
  ...
  /** يعيد نص SVG (Lucide) — للاستخدام في الحقول النصية/markup. */
  function markup(name, size) {
    var px = size || 24;
    return '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="' + px + '" height="' + px +
      '" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" ' +
      'aria-hidden="true" class="lucide lucide-' + name + '">' + (PATHS[name] || '') + '</svg>';
  }

  ALW.icons = { paths: PATHS, node: node, markup: markup, names: Object.keys(PATHS) };
